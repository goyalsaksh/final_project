...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 23, 2023 at 09:33 PM
...
('abcd', 'Male', 'Gurgaon', 'abcd12', 'abcd1234'),
('test', 'Male', 'Gurugram', 'test9876', 'test9876');
...
(9, 'Sakshi Goyal', '2002-02-24', 'SDev', 'Yes', 'Facebook', 'Suraj Ganj,Sadabad', 'Suraj Ganj,Sadabad', 7454901396, 7454901396, 'goyalsakshi2402@gmail.com', 'Indian', 'Married', 'Z+', 'sakshigoyal@yopmail.com');
...
(27, 'sakshigoyal@yopmail.com', 'Test|Kid', 'Sakshi Goyal|Also Sakshi', 'Student|Student', '97|99', 'Y|N');
...
('test1', 'Female', 'Gurugram', 'alsosakshigoyal@yopmail.com', 'test5432', 'Y'),
('test', 'Male', 'Gurugram', 'sakshigoyal@yopmail.com', 'sakshi', 'Y');
...
ALTER TABLE `lang`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `username` (`username`),
  ADD KEY `fk_lang_username` (`username`);
